      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        {!paypalConfigured && (
          <div className="mt-5 rounded-3xl border border-blue-400/20 bg-blue-400/[0.06] p-5 text-sm leading-6 text-blue-100/70">
            PayPal is not fully configured. Add the required PayPal Live environment variables before enabling real checkout.
          </div>
        )}
        ...
        <div className="mt-6 grid gap-5 xl:grid-cols-[1.35fr_.65fr]">
          <section className="rounded-[30px] border border-white/[0.08] bg-white/[0.025] p-6">
            <p className="text-[10px] font-black tracking-[0.25em] text-[#F2C94C]">PAYPAL CONFIGURATION</p>
            <h1 className="mt-2 text-2xl font-black">Pricing, discovery and checkout</h1>
            <p className="mt-2 text-sm leading-6 text-white/38">PayPal is the only payment provider. Passed profiles recycle automatically after the selected testing period.</p>
